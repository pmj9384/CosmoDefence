...
- 무한 모드와 보스: 클리어 개념을 버리고 CSV 패턴 순환 + HP 점증으로 전환, 20웨이브마다 2×2 보스(예고 → 등장 4초 대기 → 주기 공격·소환) — 구조는 §2 참고
